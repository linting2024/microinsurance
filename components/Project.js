export default function Project({ linkURL, imageURL, project_title, contents }) {
    ...
    return (
        <div>
            ...
            <div className="absolute inset-0 m-2 bg-black bg-opacity-30 rounded-b-lg flex flex-col justify-center items-center text-center group-hover:opacity-70 transition-opacity duration-300 ease-in-out">
