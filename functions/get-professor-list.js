export default function getProfessorList() {
    const professorList = [
        {
            id: "1",
            name: "林文昌",
            department: "國立中正大學 財務金融學系",
            position_title: " 教授",
            imageURL: "/images/tr1.jpg",
